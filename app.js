...
const API_KEY = "AIzaSyCPwegxxUL5OFcM4p9Zp_-VHqqJrSiLI5o";
...
setTimeout(() => {
    const botMsgHTML = `<img src="Cg.png" class="avatar"><p class="message-text">Just a sec..</p>`;
...
document.addEventListener("click", ({ target}) => {
    ...
    const shouldHide = target.classList.contains("prompt-input") || (wrapper.classList.contains
        ("hide-contains") && (target.id === "add-file-btn" || target.id === "stop-response-btn"));
